...
<html lang="en">
    ...
    <body>
        ...
        ?>
        <center>
            <h1 id="h1">Welcome to Haram Public Hospital Services Portal!</h1>
            <table width="50%" id="table1">
                ...
                <tr id="ParasTable">
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                            Our Pharmacy is equipped with Top-notch MoHaP-approved equipment and storing conditions<br>and we make sure that all our available inventory is safe for consumption.
                        </p>
                    </td>
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                            With our high-tech labs and professional personnel we try our best to get you the most accurate results.
                        </p>
                    </td>
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                            Book an appointment with one of our global grade doctors to get you checked-up and cleared of any complaint that you have.
                        </p>
                    </td>
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                            You can check out our available Cancer treatment programs, our techniques and how we deal with Cancer Warriors.
                        </p>
                    </td>
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                            If you need assistance outside hospital grounds we got you covered! click on this button and reserve the services you need!
                        </p>
                    </td>
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                            If your doctor has approved you for surgery and gave you an authorization ID, you may book your surgery here to save time.
                        </p>
                    </td>
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                         Come and take our preventive medicine course to educate yourself on how to lead a lifestyle thaty prevents accumalative sicknesses from developing.
                        </p>
                    </td>
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                            Our Emergency Services are Top-notch and has a quick reaction with a passion to save lives. don't hesitate to call 122 so we can come assist you.
                        </p>
                    </td>
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                            Our dentistry department offers expert, personalized care with advanced technology, covering all dental needs in a comfortable setting.
                        </p>
                    </td>
                    <td colspan="2" class="td" align="center">
                        <p class="Paras">
                            Our ICU provides expert, round-the-clock critical care with advanced technology and a dedicated medical team.
                        </p>
                    </td>
                </tr>
            </table>
