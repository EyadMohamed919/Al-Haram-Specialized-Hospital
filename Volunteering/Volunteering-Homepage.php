    ...
    <body>
        ...
        <br>Volunteering in hospitals is a noble act that can significantly impact the lives of patients and their families.
            ...
            hospital volunteers play a vital role in enhancing the overall quality of healthcare and creating a more compassionate healthcare system.</p><hr> 
             ...
             <a href="volunteeringUserSide/Medical Volunteering.php" target="_blank"></a>
             <a href="volunteeringUserSide/Medical Volunteering.php" class="button-link">
             ...
             <a href="volunteeringUserSide/Office Volunteering.php" target="_blank"></a>
             <a href="volunteeringUserSide/Office Volunteering.php" class="button-link">
             ...
             <a href="volunteeringUserSide/Child Life Volunteering.php" target="_blank"></a>
             <a href="volunteeringUserSide/Child Life Volunteering.php" class="button-link">
