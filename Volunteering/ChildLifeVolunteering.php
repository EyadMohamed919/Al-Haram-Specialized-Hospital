...
<html lang="en">
    ...
    <body>
        ...
        <center>
    <form action="CLVForm.php" method="post" onsubmit="return validateForm()">
    <table border="1">
        <tr>
            <td>First Name</td>
        ...
        <tr>
            <td>Start Date<label for="startDate">When are you going to start volunteering at our hospital?</label></td>
            <td><input type="date" id="startDate" name="startDate" required></td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                <button type="submit">Proceed with the volunteering process</button>
