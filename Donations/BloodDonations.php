                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>Type A</td>
                                <td><input type="checkbox" id="TypeA" value="A" name="TypeA"></td>
                            </tr>
                            <tr>
                                <td>Type B</td>
                                <td><input type="checkbox" id="TypeB" value="B" name="TypeB"></td>
                            </tr>
                            <tr>
                                <td>Type O</td>
                                <td><input type="checkbox" id="TypeO" value="O" name="TypeO"></td>
                            </tr>
                            <tr>
                                <td>Type AB</td>
                                <td><input type="checkbox" id="TypeAB" value="AB" name="TypeAB"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
